...
// quick questions → a personalized profile summary → the existing signup form.
// See components/onboarding/PreflightWizard.tsx for the flow, and
...
export const metadata: Metadata = {
  ...
  description: 'Three quick questions, then your personalized study profile.',
