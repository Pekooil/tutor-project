...
// The Landing v3 hero: split layout — copy + waitlist form left, the
    ...
    >
      <div className="mx-auto grid max-w-[1400px] gap-12 px-6 pt-10 max-lg:pb-16 lg:grid-cols-[minmax(0,1fr)_640px] lg:pl-16 lg:pr-0 lg:pt-6">
        <div className="flex flex-col pb-4 lg:pb-20 lg:pt-16">
          ...
          <h1 className="mkt-display mkt-h1 mt-6 max-w-[13ch] text-foreground">
            a tutor&apos;s voice, on your homework page.
          </h1>
          ...
          <WaitlistForm source="hero" className="mt-8 w-full max-w-md" />
