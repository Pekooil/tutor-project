...
import type { ProfileOverview, ProfileTag, TurnMessage } from '../types/messages';
...
export type OverlayTransports = {
  ...
  /** The proactive opening scan (Sprint 14 Task 6, ADR-030) -- see Overlay.tsx's prop comment. */
