...
## Current sprint
Sprint 17 — Onboarding + beta instrumentation (usability + observability) (Task 1 of 9 — ADRs + pointers — done 2026-07-09; ADRs numbered 039/042/043 — feedback KEEPS the plan's 039 (the one Sprint 17 number still free, pre-reserved per architecture.md's ADR-040 note); onboarding 037→042 and telemetry 038→043 renumbered off the prompt-caching track's collision, with 040/041 held by landing-demo-v2 + cost-guardrail). Sprint 16 — Cost control + compliance hardening (parallel track) — IN PROGRESS. Sprint 20's marketing landing page (parallel track) is COMPLETE (2026-07-06). Sprint 25 — landing page v2 to match the redesigned extension (parallel track, `/docs/sprint-25-plan.md`) — IN PROGRESS (Task 1 of 10 — ADR + pointers — done 2026-07-09).
