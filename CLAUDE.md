...
## Current sprint
Sprint 16 — Cost control + compliance hardening (Task 1 of 9 — ADRs + pointers — done 2026-07-09; ADRs numbered 041/035/036, not the plan's 034/035/036 — 034 was taken by status-pins). Sprint 20's marketing landing page (parallel track) is COMPLETE (2026-07-06). Sprint 25 — landing page v2 to match the redesigned extension (parallel track, `/docs/sprint-25-plan.md`) — IN PROGRESS (Task 1 of 10 — ADR + pointers — done 2026-07-09).
