...
## Current phase
Phase 2, Sprint 16 — Cost control + compliance hardening (Task 1 of 9 — ADRs + pointers — done 2026-07-09; ADRs 041/035/036). Sprint 20's marketing landing page (parallel track) is COMPLETE (2026-07-06). Sprint 25 — landing page v2 to match the redesigned extension (parallel track, `/docs/sprint-25-plan.md`) — IN PROGRESS (Task 1 of 10 done 2026-07-09).
